            ...
            const advancedSettingsContent = (
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch field='pass_through_header_enabled' label={t('透传请求头')} checkedText={t('开')} uncheckedText={t('关')} onChange={(value) => handleChannelSettingsChange('pass_through_header_enabled', value)} extraText={t('透传下游请求头到上游（自动排除 Authorization/api-key/x-api-key 并过滤 hop-by-hop 控制头）')} />
