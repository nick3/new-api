...
export function ChannelMutateDrawer({
  ...
  const currentPassThroughHeaderEnabled = form.watch(
    'pass_through_header_enabled'
  )
  ...
  const extraSettingsConfigured = Boolean(
    ...
    currentPassThroughHeaderEnabled ||
                                      ...
                                      {currentType === 1 ? (
                                        <>
                                          <span className='block'>
                                            {t(
                                              'Custom API base URL. Leave empty to use provider default.'
                                            )}
                                          </span>
                                          <span className='block'>
                                            {t(
                                              'OpenAI channels: when the base URL contains a path (such as /v2 or /v1), New API does not append /v1. Include /v1 explicitly if the upstream requires it. Cloudflare AI Gateway URLs do not need an extra /v1.'
                                            )}
                                          </span>
                                        </>
                                      ) : (
                                ...
                                render={({ field }) => (
                                  <FormItem className='flex items-center justify-between px-4 py-3'>
                                    <div className='space-y-0.5'>
                                      ...
                                      <FormDescription>
                                        {t(
                                          'Forward downstream request headers to the upstream, excluding credentials and connection-specific headers.'
                                        )}
                                      </FormDescription>
                                    </div>
                                    <FormControl>
